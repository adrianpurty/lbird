                ...
                <div className="p-6 md:p-8 flex flex-col lg:flex-row gap-8 items-start lg:items-center">
                  ...
                  <div className="w-full lg:w-auto lg:pl-8 flex flex-row lg:flex-col items-center lg:items-end justify-between lg:justify-center gap-3">
                     ...
                     <div className="flex gap-2">
                        <button className="p-2.5 bg-neutral-950 hover:bg-white/5 border border-neutral-800 rounded-xl text-neutral-600 hover:text-white transition-all">
                           <FileText size={16} />
                        </button>
                        <button className="p-2.5 bg-neutral-950 hover:bg-white/5 border border-neutral-800 rounded-xl text-neutral-600 hover:text-cyan-400 transition-all">
