  ...
  <div className="max-w-4xl mx-auto p-6 md:p-12 space-y-8 animate-in fade-in duration-500">
    ...
    <div className="bg-surface border border-bright rounded-[2.5rem] p-8 md:p-12 space-y-10 text-neutral-300 font-clean leading-relaxed shadow-2xl">
      ...
      <section className="space-y-4">
        ...
        <p>Fiscal reconciliation is only permitted if a Lead Node remains offline for more than 48 hours post-acquisition or if delivery telemetry shows excessive transmission failure rates. Admin audit is required for all claims.</p>
      </section>
    </div>
  </div>
);
