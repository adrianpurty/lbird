      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-10 border-b-2 border-neutral-900 pb-8 md:pb-12">
        <div className="relative">
          ...
          <h2 className="text-3xl md:text-4xl font-futuristic text-white italic uppercase flex items-center gap-4 md:gap-8 text-glow">
            AUTH <span className="text-neutral-600 font-normal">INFRA</span>
          </h2>
          <div className="flex flex-wrap items-center gap-3 md:gap-6 mt-4 md:mt-6">
            <div className="px-3 md:px-4 py-1.5 bg-purple-500/10 border border-purple-500/30 rounded-full text-[8px] md:text-[10px] font-black text-purple-400 uppercase tracking-widest">IDENTITY_GATEWAY_v4</div>
            <span className="text-[10px] md:text-[12px] text-neutral-600 font-bold uppercase tracking-widest italic shrink-0">OIDC_PROTOCOLS_ACTIVE</span>
          </div>
        </div>
        <div className="flex items-center gap-2 md:gap-4 w-full md:w-auto">
          ...
          <button 
            ...
            onClick={handleSave} 
            disabled={isSaving} 
            className={`flex-1 md:flex-none px-6 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-black text-[9px] md:text-[12px] uppercase tracking-widest flex items-center justify-center gap-3 md:gap-4 transition-all border-b-4 active:scale-[0.98] ${
              saveSuccess 
