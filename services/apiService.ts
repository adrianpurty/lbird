...
class ApiService {
  ...
  private getFallbackDB() {
    ...
    const initialData = {
      ...
      users: [
        { id: 'admin_root', name: 'ROOT_ADMIN', username: 'admin', password: '123456', email: 'admin@leadbid.pro', balance: 1000000, role: 'admin', stripeConnected: true, wishlist: [] },
        { id: 'admin_1', name: 'System Administrator', username: 'sys_admin', password: '1234', email: 'sys@leadbid.pro', balance: 1000000, role: 'admin', stripeConnected: true, wishlist: [] }
      ],
      purchaseRequests: [],
      invoices: [],
      notifications: [],
